...
import { Users, Package, ShoppingBag, DollarSign, Plus, Edit, Trash2, FolderTree, Palette, TrendingUp, Gift, CreditCard, Settings, CheckCircle, XCircle, Clock, BarChart3, PieChart, LineChart, BookOpen } from 'lucide-react';
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8" data-testid="admin-stats">
            ...
            <div className="glass-panel rounded-xl p-6">
              ...
              <p className="text-3xl font-bold" data-testid="total-revenue">{stats.total_revenue.toFixed(0)}₽</p>
            </div>
          </div>
        )}
